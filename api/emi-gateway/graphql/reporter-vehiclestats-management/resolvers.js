...
const DISABLE_AUTH_FOR_DEVELOPMENT =
  process.env.DISABLE_AUTH_FOR_DEVELOPMENT === "true";
    ...
    ReporterVehicleStatsModified: {
      subscribe: withFilter(
        (payload, variables, context, info) => {
          ...
          if (DISABLE_AUTH_FOR_DEVELOPMENT) {
            console.log(
              `Development mode: Bypassing subscription authentication`
            );
        ...
        (payload, variables, context, info) => {
          return payload
            ? payload.ReporterVehicleStatsModified.id === variables.id ||
                variables.id === "ANY"
            : false;
        }
      ),
