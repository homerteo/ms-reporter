    ...
    return (
        <div>
            <TextField
                ...
                label={T.translate("vehiclestats.metadata.createdBy")}
                id="createdBy"
                name="createdBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehiclestats.metadata.createdAt")}
                id="createdAt"
                name="createdAt"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehiclestats.metadata.updatedBy")}
                id="updatedBy"
                name="updatedBy"
            ...
            <TextField
                className={`mt-8 mb-16 ${fullHalfStyle}`}
                label={T.translate("vehiclestats.metadata.updatedAt")}
                id="updatedAt"
                name="updatedAt"
